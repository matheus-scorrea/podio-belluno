...
class IndicadorStatusTest extends TestCase
{
    ...
    {
        $this->assertSame(1.0, \App\Support\MetasMarco::realizadoComoMarco(100, 100));
        $this->assertSame(0.0, \App\Support\MetasMarco::realizadoComoMarco(0, 100));
        $this->assertSame(1.0, \App\Support\MetasMarco::realizadoComoMarco(1, 1));
        $this->assertSame(0.0, \App\Support\MetasMarco::realizadoComoMarco(0, 0));
        $this->assertSame(1.0, \App\Support\MetasMarco::realizadoComoMarco(8, 0));
    }
}
